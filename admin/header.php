<div class="header navbar navbar-inverse ">
  <div class="navbar-inner">
    <div class="header-seperation" style="background-color: rgb(27,30,36)">
      ...
      <a href="home.php" style="color:#3498db; font-size:44px; padding-top:15px;padding-left: 25px">Mobicom®
</a>
      ...
      <div class="pull-right">
        <div class="chat-toggler">
          <div class="user-details">
            <div class="username"> <span class="bold" style="color: #e74c3c">Admin</span> </div>
          </div>
