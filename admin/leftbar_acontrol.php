      ...
      <li class="start"> <a href="home.php" style="font-size: 24px"> Dashboard</span>  </a> 
          ...
          <li><a href="change-password.php" style="font-size: 20px">Change Password</a></li>
                            <li><a href="manage-users.php" style="font-size: 24px"> Normal Users</a></li>
                             <li><a href="manage-interns.php" style="font-size: 24px"> Interns </a></li>
                          ...
                          <li><a href="manage-tickets.php" style="font-size: 24px"> Manage Ticket</a></li>
                              <li ><a href="manage-quotes.php" style="font-size: 24px"> Manage Quotes</a></li> 
                              <li><a href="manage-career.php" style="font-size: 23px"> Manage  Career</a></li>   
                            <li><a href="user-access-log.php" style="font-size: 23px;color: white">User Access Log</a></li>
