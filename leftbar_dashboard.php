...
{?>
    <ul style="margin-top: 50px">	
      <li class="start"> <a href="dashboard.php"> <span class="title" style="font-size: 24px; color: white">Dashboard</span> <span class="selected"></span>  </a> 
		    </li>
          ...
          <li class="start" ><a href="change-password.php" style="font-size: 24px"> Change Password</a></li>
                            <li><a href="profile.php" style="font-size: 24px"> Profile</a></li>
                              ...
                              <li ><a href="get-quote.php" style="font-size: 24px"> Request a Quote</a></li>
